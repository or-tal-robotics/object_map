...
def ssd_bboxes_select(predictions_net,
    ...
    for i in range(len(predictions_net)):
        classes, scores, bboxes, probs = ssd_bboxes_select_layer(
    ...
    l_probs = np.concatenate(l_probs, 0)
    return classes, scores, bboxes , l_probs


# =========================================================================== #
# Common functions for bboxes handling and selection.
# =========================================================================== #
def bboxes_sort(classes, scores, bboxes,probs, top_k=400):
    ...
    sprobs = probs[idxes][:top_k]
    return classes, scores, bboxes, sprobs
...
def bboxes_nms(classes, scores, bboxes,probs, nms_threshold=0.45):
    ...
    return classes[idxes], scores[idxes], bboxes[idxes], probs[idxes]
